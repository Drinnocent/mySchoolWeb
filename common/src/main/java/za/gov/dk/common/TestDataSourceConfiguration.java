 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"za.gov.dk.persistence"}, transactionManagerRef = "transactionManager") 
@ComponentScan(basePackages = {"za.gov.dk"}) 
...
public class TestDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() { 
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("za.gov.dk.domain");
