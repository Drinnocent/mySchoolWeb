 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"za.gov.dk.persistence"}, transactionManagerRef = "transactionManager") //this where repositories are act
@ComponentScan(basePackages = {"za.gov.dk"}) //that where you scan
...
public class DataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() { //this environment it actually an enum
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("za.gov.dk.domain");//you are tellignthat this domain are sitting here
